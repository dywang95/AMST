...
from models.network_amst import AMST as net
from utils import utils_image as util


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--task', type=str, default='lightweight_sr', help='lightweight_sr')
    parser.add_argument('--scale', type=int, default=2, help='scale factor: 2, 4')
    parser.add_argument('--model_path', type=str, default='', help='pertrained_models for X2, X4')
    parser.add_argument('--folder_lq', type=str, default='', help='LR of APN100, APP30, APL30')
    parser.add_argument('--folder_gt', type=str, default='', help='HR of APN100, APP30, APL30')
    #
...
def define_model(args):
    model = net(upscale=args.scale, in_chans=3, img_size=64, window_size=8,
                img_range=1., depths=[6, 6], embed_dim=60, num_heads=[6, 6], mlp_ratio=2)
    param_key_g = 'params'
